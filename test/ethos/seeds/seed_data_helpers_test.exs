defmodule Ethos.SeedDataHelpersTest do
  ...
  test "code_places/0 covers every code-defined places module, each owning its own" do
    ...
    assert Map.keys(by_file) |> Enum.sort() == [
             "lib/ethos/seeds/american_family_field_places.ex",
             "lib/ethos/seeds/angel_stadium_places.ex",
             "lib/ethos/seeds/busch_stadium_places.ex",
             "lib/ethos/seeds/chase_field_places.ex",
             "lib/ethos/seeds/citi_field_places.ex",
             "lib/ethos/seeds/citizens_bank_park_places.ex",
             "lib/ethos/seeds/comerica_park_places.ex",
             "lib/ethos/seeds/connecticut_places.ex",
             "lib/ethos/seeds/coors_field_places.ex",
             ...
             "lib/ethos/seeds/petco_park_places.ex",
             "lib/ethos/seeds/pnc_park_places.ex",
             "lib/ethos/seeds/progressive_field_places.ex",
             "lib/ethos/seeds/rate_field_places.ex",
             "lib/ethos/seeds/rogers_centre_places.ex",
             "lib/ethos/seeds/sutter_health_park_places.ex",
             "lib/ethos/seeds/t_mobile_park_places.ex",
