defmodule Ethos.Seeds.BallparkSeedDataTest do
  ...
  **last** of three: nine patterns, no specimens, no way to tell when it has
  ...
  @ballpark_roster [
    {"t-mobile-park", "t-mobile-park-guide"},
    {"petco-park", "petco-park-guide"},
    {"chase-field", "chase-field-guide"},
    {"globe-life-field", "globe-life-field-guide"},
    ...
    {"loandepot-park", "loandepot-park-guide"},
