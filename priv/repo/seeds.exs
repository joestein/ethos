...
if Repo.get_by(User, email: demo_email) do
  ...
  [
    %{
      ...
      note: "Garlic shrimp + prego. Go at opening or queue an hour.",
      verdict: "loved"
    },
    %{
      day: 1,
      kind: "walk",
      name: "Alfama at golden hour",
      note: "Get lost on purpose. Miradouro de Santa Luzia at sunset.",
      verdict: "loved"
    },
    %{
      day: 2,
      kind: "sight",
      name: "Belém Tower",
      note: "Fine from outside; skip the interior queue.",
      verdict: "skip"
    },
    %{
      day: 2,
      ...
      note: "Yes it's touristy. Yes it's worth it. Eat them warm.",
      verdict: "loved"
    },
    %{
      day: 3,
      kind: "tour",
      name: "LX Factory",
      note: "Creative complex under the bridge — Sunday market is best.",
      verdict: "good"
    },
    %{
      day: 4,
      kind: "tip",
      name: "Carris day pass",
      note: "€6.80 covers trams incl. the 28 — buy at metro machines.",
      verdict: "good"
    }
  ]
