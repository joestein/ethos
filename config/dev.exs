...
config :ethos, EthosWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "05i8p+cvPz1qQknu7pu/sqBb6hy8hVHYATfPvWazOdUW2UTiOenD8PCBJReNwzBn",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ethos, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ethos, ~w(--watch)]}
  ]
...
config :ethos, EthosWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ethos_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ethos, dev_routes: true
