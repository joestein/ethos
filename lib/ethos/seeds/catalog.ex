defmodule Ethos.Seeds.Catalog do
  ...
  @place_modules [
    ...
    {Ethos.Seeds.CitizensBankParkPlaces, "ballparks"},
    ...
    {Ethos.Seeds.AmericanFamilyFieldPlaces, "ballparks"},
    {Ethos.Seeds.TargetFieldPlaces, "ballparks"},
    {Ethos.Seeds.KauffmanStadiumPlaces, "ballparks"},
    {Ethos.Seeds.CoorsFieldPlaces, "ballparks"},
    {Ethos.Seeds.AngelStadiumPlaces, "ballparks"},
    {Ethos.Seeds.TruistParkPlaces, "ballparks"},
    {Ethos.Seeds.LoandepotParkPlaces, "ballparks"},
    {Ethos.Seeds.DaikinParkPlaces, "ballparks"},
    {Ethos.Seeds.TropicanaFieldPlaces, "ballparks"},
    {Ethos.Seeds.GlobeLifeFieldPlaces, "ballparks"},
    {Ethos.Seeds.ChaseFieldPlaces, "ballparks"},
    {Ethos.Seeds.PetcoParkPlaces, "ballparks"},
    {Ethos.Seeds.TMobileParkPlaces, "ballparks"}
  ]
  ...
  @guide_modules [
    ...
    {Ethos.Seeds.CitizensBankParkGuide, "ballparks"},
    ...
    {Ethos.Seeds.AmericanFamilyFieldGuide, "ballparks"},
    {Ethos.Seeds.TargetFieldGuide, "ballparks"},
    {Ethos.Seeds.KauffmanStadiumGuide, "ballparks"},
    {Ethos.Seeds.CoorsFieldGuide, "ballparks"},
    {Ethos.Seeds.AngelStadiumGuide, "ballparks"},
    {Ethos.Seeds.TruistParkGuide, "ballparks"},
    {Ethos.Seeds.LoandepotParkGuide, "ballparks"},
    {Ethos.Seeds.DaikinParkGuide, "ballparks"},
    {Ethos.Seeds.TropicanaFieldGuide, "ballparks"},
    {Ethos.Seeds.GlobeLifeFieldGuide, "ballparks"},
    {Ethos.Seeds.ChaseFieldGuide, "ballparks"},
    {Ethos.Seeds.PetcoParkGuide, "ballparks"},
    {Ethos.Seeds.TMobileParkGuide, "ballparks"}
  ]
